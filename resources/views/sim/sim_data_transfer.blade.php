        ...
        <div class="row">
            <div class="content-csv">
                ...
                <div class="flex-container">
                    <div style="flex: 1;">
                        <label for="usernameId">SVファイルを選択</label>
...
<script>
    ...
    document.getElementById('uploadBtn').addEventListener('click', function() {
        ...
        reader.onload = function(event) {
            ...
            fetch("{{ route('sim.check_sim_data') }}", {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    simNumbers.forEach((simNumber, index) => {
                        ...
                        `;
                            ...
                            row.innerHTML = `
                            <td>${index + 1}</td>
                            <td colspan="7">Số SIM "${simNumber}" không tồn tại</td>
                        `;
    ...
    document.getElementById('confirmBtn').addEventListener('click', function() {
        ...
        tableRows.forEach(row => {
            ...
            const isValid = cells[5].innerText !== "SIM không tồn tại";
        ...
        fetch("{{ route('sim.update_manager_data') }}", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
